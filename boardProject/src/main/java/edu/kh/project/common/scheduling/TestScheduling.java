...
public class TestScheduling {
	...
	// @Scheduled() 매개변수
	// 1) fixedDelay 
	//  - 이전 작업이 끝난 후 다음 작업이 시작할 때까지의 시간을 지정 
	...
	//  ex) [2024년] 5월 7일 화요일 12시 50분 0초에 수행 (일요일 1 ~ 토요일 7)
...
//	@Scheduled(fixedRate = 5000)
	...
	//@Scheduled(cron="59 59 23 * * *") //다음 날 되기 1초전
