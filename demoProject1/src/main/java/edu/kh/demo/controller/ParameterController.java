...
public class ParameterController {
	...
	public String paramMain() {
		...
		return "param/param-main"; //접두사 , 접미사 생략
	}
	 ...
	 * 매개 변수에 원하는 객체를 작성하면
	 * 존재하는 객체를 바인딩 또는 없으면 생성해서 바인딩을 해줌
	 * 
	...
	public String paramTest2(@RequestParam("title") String title,
							 ...
							 @RequestParam("price") int price, //알아서 파싱해줌
